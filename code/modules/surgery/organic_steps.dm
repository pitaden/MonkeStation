...
/datum/surgery_step/incise
	...
	implements = list(TOOL_SCALPEL = 63, /obj/item/melee/transforming/energy/sword = 47, /obj/item/kitchen/knife = 47,
		/obj/item/shard = 32, /obj/item = 16) // 30% success with any sharp item.
	time = 16
...
/datum/surgery_step/retract_skin
	name = "retract skin"
	implements = list(TOOL_RETRACTOR = 63, TOOL_SCREWDRIVER = 47, TOOL_WIRECUTTER = 47)
	time = 24
...
/datum/surgery_step/close
	name = "mend incision"
	implements = list(TOOL_CAUTERY = 63, /obj/item/nullrod/godhand = 63, /obj/item/gun/energy/laser = 63, TOOL_WELDER = 63,
...
/datum/surgery_step/saw
	name = "saw bone"
	implements = list(TOOL_SAW = 63,/obj/item/melee/arm_blade = 47,
